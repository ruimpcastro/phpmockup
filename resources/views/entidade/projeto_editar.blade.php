    ...
    <div class="info-section-container">
        ...
        <div class="info-section">
            <form action="/projeto/{{$projeto->id}}/editar" method="post">
                ...
                <p>Projeto: </p><input name="titulo" type="text" value="{{$projeto->titulo}}"><br><br>
                <p>Supervisor: </p><input name="supervisor" type="text" value="PLACEHOLDER"><br><br>
                <p>Perfil Profissional: </p>
                <textarea name="perfilProfissional" cols="50" rows="2">{{$projeto->perfilProfissional}}</textarea>
                <br><br>
                <p>Descrição: </p>
                <textarea name="descricao" cols="50" rows="10">{{$projeto->descricao}}</textarea>
                <br><br>
                <p>Cronograma:</p><br>
