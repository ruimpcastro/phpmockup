...
@section('mainpage-contents')
    ...
    <div class="info-section-container">
        ...
        <div class="info-section">
            ...
            <textarea name="mensagem" cols="50" rows="2" required>A sua proposta de estágio ({{$projeto->titulo}}) foi reprovada! Segue uma justificação do diretor de estágios:</textarea><br><br>
